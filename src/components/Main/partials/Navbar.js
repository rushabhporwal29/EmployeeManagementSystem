    ...
    <div>
      <header className="text-gray-300  body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a className="flex title-font font-medium items-center text-gray-500 mb-4 md:mb-0" href='/'>
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a className="mr-5 hover:text-gray-900" href='/employees'>Employees</a>
            <a className="mr-5 hover:text-gray-900" href='/attendance'>Attendance</a>
            <a className="mr-5 hover:text-gray-900" href='/'>Profile</a>
          </nav>
